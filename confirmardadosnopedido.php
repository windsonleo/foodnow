...
<head>
  ...
  <title> Confirmar dados no pedido </title>
...
<?php include 'headersembannerconfirmardadosnopedido.php';?>
...
<!--  <a href="excluiritem.php?iditem=<?php echo $id; ?>" class="btn btn-outline-danger btn-sm"> excluir</a> -->
   ...
   <div class="col-md-4">
    ...
    <div class="card-header  bg-success text-white">Dados do Carrinho</div>
 ...
 <div class="card-body">
    ...
    <li class="list-group-item">cliente :  <?php echo $carrinho->getcliente(); ?></li>
...
<!--   <div class="btn-group btn-group-sm" role="group">
    ...
    <a href="confirmardados.php" class="btn btn-outline-success btn-sm" role="button">Finalizar Pedido</a>
    ...
    <div class="card-header  bg-primary text-white">Dados da Entrega</div>
    <!-- <p class="card-text">dados do seu carrinho.</p> -->
  
 <div class="card-body">

    <ul class="list-group list-group-flush">
    <li class="list-group-item">Rua :  <?php echo $endereco->getlogradouro(); ?>  </li>
    <li class="list-group-item">Numero :  <?php echo $endereco->getnumero(); ?></li>
    <li class="list-group-item"> Cep : <?php echo $endereco -> getcep(); ?></li>
      <li class="list-group-item">Bairro : <?php echo $endereco -> getbairro(); ?></li>
            <li class="list-group-item">Cidade : <?php echo $endereco -> getcidade(); ?></li>

                  <li class="list-group-item">Complemento : <?php echo $endereco -> getcomplemento(); ?></li>
...
<!--   <div class="btn-group btn-group-sm" role="group">
    ...
    <div class="card-header  bg-warning text-white">Dados do Pagamento</div>
    <!-- <p class="card-text">dados do seu carrinho.</p> -->
 ...
 <div class="card-body">
    ...
    <li class="list-group-item">Troco :  <?php echo $troco; ?></li>
...
<!--   <div class="btn-group btn-group-sm" role="group">
    ...
    <a href="confirmardados.php" class="btn btn-outline-success btn-sm" role="button">Finalizar Pedido</a>
	    ...
	    <form action="finalizarPedido.php" method="POST">
               ...
               <button id="btnfinalizarpedido" class="btn btn-outline-success btn-lg btn-block" type="submit" > Finalizar</button>
