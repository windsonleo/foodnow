...
<head>
  ...
  <title> Finalizar Pedido Pagamento </title>
...
<?php include 'headersembannerpagamento.php';?>
...
<!--         <h2>
 ...
 <!--    <p class="card-text">dados do seu carrinho.</p>  -->
      ...
      <form action="salvarpagamentonopedido.php" method="POST"> 
    ...
    <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" placeholder="Digite o troco"  class="form-control-plaintext" name="troco" id="statictroco" value="">
              ...
              <div class="form-group row">
                ...
                <button id="btnvalidarpagamento" class="btn btn-primary" type="submit">Salvar</button>
      ...
      <hr>
    <button id="btnfinalizarpedido" class="btn btn-outline-success btn-lg btn-block" type="button"  disabled> Finalizar</button>
