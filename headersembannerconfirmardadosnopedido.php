...
<span class="badge">  <?php echo $totalitenscarrinho; ?>  </span>
  ...
  <div class="container">
    <h1 class="display-4">Olá</h1>
     <h4 class="display-6"> <?php echo $cliente->getnome(); ?></h4>
    <p class="lead"> Entrega : <?php echo $cliente->get_endereco(); ?></p>
    <p class="lead"> Forma de Pagamento : <?php echo $pagamento; ?></p>
    <p class="lead"> Troco: <?php echo $troco; ?></p>
